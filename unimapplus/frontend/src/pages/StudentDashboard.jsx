...
export default function StudentDashboard() {
  ...
  async function handleCheckout(vendorId) {
    ...
    // Test
    const bakeryItems = cartArr; // ALL items go through review flow for bakery vendors
    const normalItems = [];
                  ...
                  >
                    ...
                    >
                      ...
                      <span
                        style={{
                          ...
                          padding: "4px 12px",
                          borderRadius: 20,
                          background: `${statusColors[trackedOrder.status]}18`,
                          color: statusColors[trackedOrder.status],
                        }}
                      >
                    ...
                    >
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        <div style={{ fontSize: 11, color: "#7a90a4" }}>
                          Order #{String(trackedOrder.order_id).slice(-6)} · ₦
                          {Number(trackedOrder.total_amount).toLocaleString()}
                        </div>
                      </div>
                      {trackedOrder.driver_phone && (
                        <a
                          href={`tel:${trackedOrder.driver_phone}`}
                          style={{
                            background: TEAL,
                            color: "#fff",
                            borderRadius: 10,
                    ...
                    {trackedOrder.status === "awaiting_payment" && (
                      ...
                      >
                        {checkoutLoading
                          ? "Processing..."
                          : `Pay ₦${Number(trackedOrder.total_amount).toLocaleString()} Now`}
                      </button>
                    )}
                      ...
                      >
                        ...
                        >
                          <div style={{ textAlign: "center" }}>
                            ...
                            >
                              ~{trackedOrder.estimated_delivery_time || 30}
                            </div>
                    ...
                    {trackedOrder.status === "pending" && (
                      <button
                        onClick={() => deleteOrder(trackedOrder.order_id)}
                        style={{
                          background: "#fff0f0",
                          color: "#e74c3c",
                          border: "none",
                      ...
                      {trackedOrder.items?.map((item, i) => (
                        <div
                          ...
                          style={{
                            ...
                            fontSize: 13,
                            marginBottom:
                              i < trackedOrder.items.length - 1 ? 4 : 0,
                          }}
                        >
                  ...
                  .map((v) => {
                    ...
                    const deliveryFee = deliveryAddr.trim()
                      ...
                      : vendorCat === "foodstuff"
                        ...
                        : 600;
                    const grandTotal =
                      subtotal + deliveryFee + vPacking + serviceFee;
                    return (
                      <div
                        key={v.vendorId}
                        style={{
