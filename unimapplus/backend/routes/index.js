...
const { register, login, sendSchoolEmailOTP, verifySchoolEmailOTP, sendResetOTP, resetPassword, saveBankDetails, getBanks, resolveAccount } = require('../controllers/authController');
...
router.get('/auth/resolve-account', resolveAccount);
